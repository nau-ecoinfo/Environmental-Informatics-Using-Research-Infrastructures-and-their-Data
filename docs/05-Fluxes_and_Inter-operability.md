...
```
## Skipping install of 'NEONprocIS.base' from a github remote, the SHA1 (d157ee15) has not changed since last install.
##   Use `force = TRUE` to force installation
```
...
## Downloading 1 files
##   |                                                                              |                                                                      |   0%  |                                                                              |======================================================================| 100%
## 1 files successfully downloaded to C:\Users\rohan\AppData\Local\Temp\RtmpoBBJje/filesToStack00200
## Finding available files
##   |                                                                              |                                                                      |   0%  |                                                                              |======================================================================| 100%
## 
...
## Ncells  1494449  79.9    3173390 169.5  3173390 169.5
## Vcells 16219876 123.8   72281728 551.5 75226752 574.0
```
...
```
##            used  (Mb) gc trigger  (Mb) max used  (Mb)
## Ncells  1496905  80.0    3173390 169.5  3173390 169.5
## Vcells 16294019 124.4   57825383 441.2 75226752 574.0
```
