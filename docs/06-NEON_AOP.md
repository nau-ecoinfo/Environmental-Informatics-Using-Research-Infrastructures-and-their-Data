...
- [*NEON AOP Written Questions*](#neon-aop-written-questions) Demonstrate your knowledge of NEON AOP's philosophy and practices, and identify how these intersect with your own research interests (6.14.1).

- [*NEON AOP Coding Lab*](#neon-aop-coding-lab) Access NEON AOP data using the `neonUtilities` package and use it generate LiDAR point clouds with the `lidR` package (6.14.2).

- [*NEON AOP Culmination Activity*](#neon-aop-culmination-activity) Summarize a project you might explore using Data from NEON AOP (6.14.3).
