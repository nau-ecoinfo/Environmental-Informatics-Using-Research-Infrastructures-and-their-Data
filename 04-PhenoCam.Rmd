...
### Assignments in this chapter
  ...
  - *Digital Repeat Photography Coding Lab* Download and Manipulate digital repeat photography data using the R packages covered in this chapter (4.13.1).
  
  - *PhenoCam culmination activity* Summarize a project you might explore using PhenoCam (4.13.2). 
